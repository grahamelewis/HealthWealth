...
using $datadir/FAM2009ER.txt, clear ;
...
keep ER42002                 ER42003                ER42014               ER47012               ER42016                  
  ...
  /* head's marital status,  head's educ            wife's educ           head's health status, wife's health status,  health ins status   FU paid ins   SOC SEC inc (head)  */   
     ER44296                 ER44282                ER44283               ER44289               ER44291                ER44293             ER44294    ER44295     ER45393  
  /* head's health at 16     smoking                no of cigarette       alcohol drinking      no of alcohol          head's weight       head's height (ft-in)  wife's health at 16 */     
     ER46829                 ER46808                ER46761               ER46763               ER46765                ER46767             ER46901        
  /* head labor income,      head's bus lab inc     head's week work        */
     ER46770                 ER46778                ER46780            
  /* head's sick week        head's unemplyed week  head's out of lab week   */
     ER43060                 ER43061                ER43075               ER43076               ER43077               ER43078               ER43093                ER43094  
  /* head's TANF             head's TANF per        if head gets SSI      head's SSI for whom   head's SSI            head's SSI per        head's oth welfare     head's oth welfare per */
     ER46841                 ER46838                ER46788               ER46935   
  /* wife's labor income     wife's bus lab inc     wife's total hour     total family inc       */
     ER46938                 ER46942                ER46950               ER46954               ER46956                ER46960             ER46964
  /* value of farm/bus       checking/saving acc    realestate            stock                 vehicle                other asset         annuity/IRA  */
     ER46966                 ER46968                ER46970               ER46946      
  /* home equity             Net wealth W/O home eq Net wealth w home eq  total debt  */
     ER44278                 ER44279                ER44276               ER44277               ER44284 ;
  /* #light exercise         light exercise per     #heavy exercise       heavy exercise per    first age smoking  */
#delimit cr ;

*local minwage = 6.55  /* min wage in 2008 */
*local minhour = 520
local refyy   = 96
local cpi96   = 156.40
local cpi84   = 103.90
...
/* rename variables */
rename ER42002   famID    
rename ER42003   state    
rename ER42014   yearIntw  
rename ER47012   famlongwght   
rename ER46543   racei  
rename ER42017   ageH  
rename ER42018   sexi  
rename ER42019   ageW  
rename ER42020   noofkids  
rename ER42021   ageyoungest  
rename ER42023   marry  
rename ER42016   noofFU
*rename ER46981   educH  
drop ER46981
 

rename ER44175   healthH  
gen    healthH5= healthH 
recode healthH5 (0=.) (8/9=.) 
rename ER44296   healthH16  
rename ER44282   smokingH   
rename ER44283   cigarettH  
rename ER44289   alcoholH  
rename ER44291   alcoholconsH 
rename ER44284   AgeFirstSmoking 
rename ER44293   weightH  
rename ER44294   heightHft  
rename ER44295   heightHin  
rename ER45272   healthW    
rename ER45393   healthW16   
rename ER46382   famhealthins    
rename ER46383   faminsprem      

rename ER46829   labincH       /* excl business/farming */
rename ER46808   buslabincH  
rename ER46761   weekworkH  
rename ER46763   weeklyhourH   
rename ER46765   othourH    
rename ER46767   tothourH   
rename ER46901   wageH      
rename ER46770   weekillH   
rename ER46778   weekunemplyH  
rename ER46780   weekoutoflabH  
rename ER43060   TANFH   
rename ER43061   TANFperH 
rename ER43075   ifSSIH 
rename ER43076   whomSSIH
rename ER43077   SSIH  
rename ER43078   SSIperH   
rename ER43093   othwelfareH  
rename ER43094   othwelfareperH  
rename ER46929   SOCSECincH
  


rename ER46938  assetFam_FarmBus 
rename ER46942  assetFam_saving
rename ER46946  debtFam
rename ER46950  assetFam_realestate
rename ER46954  assetFam_stock
rename ER46956  assetFam_vehicle
rename ER46960  assetFam_other
rename ER46964  assetFam_annuityIRA
rename ER46966  assetFam_homeequity
rename ER46968  wealthFam1
rename ER46970  wealthFam2


rename ER44278   NoofLiteExercise
rename ER44279   LiteExercisePer       /* 2=day,3=week,4=two weeks, 5=month, 6=year, 7=oth, 8=DK, 9=NA   */   
rename ER44276   NoofHvyExercise
rename ER44277   HvyExercisePer
...
replace labincH     = labincH/`cpi08'*`cpi`refyy''
replace buslabincH  = buslabincH/`cpi08'*`cpi`refyy''
replace wageH       = wageH/`cpi08'*`cpi`refyy''

foreach var of varlist assetFam* debtFam* wealthFam1 wealthFam2 {
   replace `var'=`var'/`cpi09'*`cpi`refyy''
}



gen int wave = 2009   
label define yesnodef 1 "yes" 0 "no" 


/* the sample includes only household whose head's age is at least 20 */
*drop if ageH<20  
...
recode healthH16  (4/5=0) (1/3=1) (0 8 9=.) 
...
save $curdir/family2009, replace 
